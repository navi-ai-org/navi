...
- **Global shortcuts** — Ctrl+letter chords work across terminal encodings (e.g. Ctrl+M as CR / empty Ctrl+Enter opens the model picker). Sessions, palette, debug, and other globals covered by the same matcher
