...
pub struct TuiApp {
    ...
    /// Hovered footer segment in the subagent drill-in view (for visual feedback).
    pub(crate) hover_subagent_footer: Option<crate::ui::interaction::HitAction>,
