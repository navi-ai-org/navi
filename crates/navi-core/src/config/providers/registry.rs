    ...
    vec![
        ...
        ProviderConfig {
            ...
            models: vec![
                ...
                model_ctx("deepseek/deepseek-v4-pro", ModelTaskSize::Large, 128_000),
                model_ctx("deepseek/deepseek-chat", ModelTaskSize::Large, 128_000),
        ...
        ProviderConfig {
            ...
            base_url: None,
            models: vec![
                model_ctx("big-pickle", ModelTaskSize::Large, 256_000),
                model_ctx("deepseek-v4-flash-free", ModelTaskSize::Small, 128_000),
                model_ctx("nemotron-3-super-free", ModelTaskSize::Small, 128_000),
                model_ctx("qwen3.6-plus", ModelTaskSize::Large, 128_000),
                model_ctx("qwen3.5-plus", ModelTaskSize::Large, 128_000),
                model_ctx("kimi-k2.6", ModelTaskSize::Large, 128_000),
                model_ctx("kimi-k2.5", ModelTaskSize::Large, 128_000),
                model("glm-5.1", ModelTaskSize::Large),
                model_ctx("glm-5", ModelTaskSize::Large, 128_000),
                model_ctx("minimax-m2.7", ModelTaskSize::Small, 128_000),
                model_ctx("minimax-m2.5", ModelTaskSize::Small, 128_000),
