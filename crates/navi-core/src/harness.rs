...
fn build_system_prompt_inner(
    ...
    let mut prompt = format!(
        concat!(
            ...
            "- File content shown by read_file is minified (whitespace, comments, indentation removed).\n",
            "- When writing files, write compact/minified content — the VFS auto-formats on disk.\n",
            "- Do not add comments or decorative whitespace in file writes.\n",
            "\n",
            "Response rules:\n",
            "- Be concise.\n",
