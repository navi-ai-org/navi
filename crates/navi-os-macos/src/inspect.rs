...
pub fn inspect_element(opts: &MacInspectOptions) -> Result<MacElementTree> {
    unsafe {
        ...
        let root_element = if let Some(window_number) = opts.window {
            ...
            core_foundation_sys::base::CFRelease(system as _);
        ...
        if let Some(ref target_id) = opts.element_id {
            ...
            match found {
                Some(element) => {
                    ...
                    core_foundation_sys::base::CFRelease(root_element as _);
    ...
    unsafe {
        ...
        *counter += 1;
        ...
        for i in 0..limit {
            ...
            core_foundation_sys::base::CFRelease(children[i] as _);
        }
        found
    }
}
...
unsafe fn cf_string_create(s: &str) -> Option<core_foundation_sys::string::CFStringRef> {
    unsafe {
...
unsafe fn cf_type_id_string(value: core_foundation_sys::base::CFTypeRef) -> Option<String> {
    unsafe {
...
unsafe fn get_position_and_size(element: accessibility_sys::AXUIElementRef) -> Option<MacRect> {
    unsafe {
        ...
        core_foundation_sys::base::CFRelease(position as _);
        core_foundation_sys::base::CFRelease(size as _);
