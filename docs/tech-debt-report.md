...
|---|-------|----------|--------|
| 1 | `navi-core` public API has almost no doc comments | All `navi-core/src/*.rs` | DONE |
...
| 7 | `navi-sdk` public API returns `anyhow::Result` everywhere | `navi-sdk/src/engine.rs` | DONE |
