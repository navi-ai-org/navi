...
# Pre-PR: verify + clippy
ci: verify clippy

# Install common cargo tooling used by coverage/CI helpers
setup-tools:
    @echo "Installing cargo tools..."
    cargo install cargo-llvm-cov cargo-nextest cargo-audit cargo-deny cargo-hack --locked
